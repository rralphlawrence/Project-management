    ...
    <div class="main-content">
        ...
        <main>
                <div class="illustration">
                   ...
                   <img class="pic" src="../img/account.png" alt="">
                    </div>
                    <div class="create">
                        
                        <p>Hello Professor ! <br> you can customize your account</p>
 ...
 <div class="wrapper usertype">
   ...
   <select name="AccountType" id="AccountType">
    ...
    <option value="Professor">Professor</option> </select>
                            ...
                            <div class="submite">
                                <div class="data">      
                                 <button type='submit' name="editprofileprof" ><i class="fas fa-user-plus"></i> SAVE CHANGES</button>
                            </div>
